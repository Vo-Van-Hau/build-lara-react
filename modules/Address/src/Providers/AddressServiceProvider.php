...
class AddressServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("module.address.namespace", "Address"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("module.address.namespace", "Address"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("module/address.php")], "config");
    }
}
