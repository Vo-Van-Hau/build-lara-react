...
class CurrenciesServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("module.currencies.namespace", "Currencies"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("module.currencies.namespace", "Currencies"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("module/currencies.php")], "config");
    }
}
