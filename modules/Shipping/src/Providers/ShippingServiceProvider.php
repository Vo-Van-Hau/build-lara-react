...
class ShippingServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("module.shipping.namespace", "Shipping"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("module.shipping.namespace", "Shipping"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("module/shipping.php")], "config");
    }
}
