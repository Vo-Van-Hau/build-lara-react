...
namespace Sellers\Auth\Providers;
...
class AuthServiceProvider extends ServiceProvider {
    ...
    public function boot() {
         ...
         */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("packages.sellers.auth.namespace", "AuthSellers"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("packages.sellers.auth.namespace", "AuthSellers"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("sellers/module/auth.php")], "config");
    }
}
