...
namespace Sellers\Dashboard\Providers;
...
class DashboardServiceProvider extends ServiceProvider {
    ...
    public function boot() {
         ...
         */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("packages.sellers.dashboard.namespace", "DashboardSellers"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("packages.sellers.dashboard.namespace", "DashboardSellers"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("sellers/module/dashboard.php")], "config");
    }
}
