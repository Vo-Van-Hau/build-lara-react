...
import { Col, Row, Image, Input, Modal, Button, Form, Typography, Space, Badge, Popover, Cascader, Divider, Menu, List, Alert, Tag, Drawer, Affix } from 'antd';
import { UserOutlined, SearchOutlined, ShoppingCartOutlined, CloseCircleOutlined, UpOutlined,
        BellOutlined, LogoutOutlined, InboxOutlined, HistoryOutlined, DownOutlined } from '@ant-design/icons';
