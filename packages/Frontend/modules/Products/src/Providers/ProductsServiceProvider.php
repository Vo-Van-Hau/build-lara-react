...
class ProductsServiceProvider extends ServiceProvider {
    ...
    public function boot() {
         ...
         */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("packages.frontend.products.namespace", "ProductsFrontend"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("packages.frontend.products.namespace", "ProductsFrontend"));
