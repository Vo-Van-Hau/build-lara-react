...
namespace Frontend\Home\Providers;
...
class HomeServiceProvider extends ServiceProvider {
    ...
    public function boot() {
         ...
         */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("packages.frontend.home.namespace", "HomeFrontend"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("packages.frontend.home.namespace", "HomeFrontend"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("frontend/module/home.php")], "config");
    }
}
