...
namespace Frontend\Shipping\Providers;
...
class ShippingServiceProvider extends ServiceProvider {
    ...
    public function boot() {
         ...
         */
        $this->loadViewsFrom(__DIR__ . "/../../resources/views", Config::get("packages.frontend.shipping.namespace", "ShippingFrontend"));

        // Load Lang
        $this->loadTranslationsFrom(__DIR__ . "/../../resources/lang", Config::get("packages.frontend.shipping.namespace", "ShippingFrontend"));
    ...
    private function publishResources() {
        ...
        //Publish Resource
        $this->publishes([__DIR__ . "/../../config/config.php" => config_path("frontend/module/shipping.php")], "config");
    }
}
